...
class MENU_TEST:
    ...
    def __init__(self):
        ...
        self.text_index = 0
        self.letter_index = 0
        self.dialog_font = pygame.font.Font('E:/Développement/RPG/0.83/assets/graphics/dialogs/dialog_font.ttf', 20)
        self.reading = False

        # CLASS DES ITEMS
        self.potion = Potion(amount=10)
        self.superpotion = SuperPotion(amount=10)
        self.superball = SuperBall(amount=10)
    ...
    def execute(self) :
        if self.reading:
            ...
            self.text = [f"Tu utilises l'objet {self.item_names[self.selection_index]}"]
            ...
            if self.item_names[self.selection_index] == 'Potion':
                ...
                self.text = [f"Potion restantes : {self.potion.amount}"]
                print(f"Potion restantes : {self.potion.amount}")
